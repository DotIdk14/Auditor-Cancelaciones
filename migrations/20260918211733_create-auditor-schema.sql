-- Auditor de Cancelaciones — esquema de persistencia
-- Expedientes (tickets), evidencias, transcripción, hechos extraídos,
-- ejecuciones del motor de decisiones, reglas evaluadas, versiones de dictamen,
-- PDFs emitidos y bitácora de auditoría.

-- ============================================================
-- 1. tickets — expediente principal de auditoría
-- ============================================================
...
-- ============================================================
-- 2. evidences — metadatos probatorios (storage_key + url)
-- ============================================================
...
-- ============================================================
-- 3. transcript_segments — diarización de audios por evidencia
-- ============================================================
...
-- ============================================================
-- 4. extracted_facts — hechos detectados (IA/extracción) por evidencia
-- ============================================================
...
-- ============================================================
-- 5. decision_runs — ejecuciones del motor de decisiones
-- ============================================================
...
-- ============================================================
-- 6. rule_evaluations — reglas aplicadas/descartadas por ejecución
-- ============================================================
...
-- ============================================================
-- 7. dictamen_versions — versionado del dictamen oficial
-- ============================================================
...
-- ============================================================
-- 8. generated_pdfs — PDFs oficiales emitidos por versión
-- ============================================================
...
-- ============================================================
-- 9. audit_events — bitácora de trazabilidad por expediente
-- ============================================================
...
-- ============================================================
-- 10. Índice global para análisis de inteligencia
--     (clasificación + causa raíz por mes para series)
-- ============================================================
CREATE INDEX decision_runs_intel_idx ON public.decision_runs (classification, root_cause, run_at);

-- ============================================================
-- 11. Funciones helper SECURITY DEFINER para RLS sin recursión
--     (se crean ANTES de las policies que las usan)
-- ============================================================
...
-- ============================================================
-- 12. RLS: la app actual opera por el server con admin client.
--     Se restringe acceso anónimo y se habilita el patrón por
--     usuario autenticado (created_by = auth.uid()) para cuando
--     se integre auth. El admin bypassea RLS.
-- ============================================================
...
-- Denegar acceso explícito al rol anónimo
...
-- Usuarios autenticados: acceso completo a sus expedientes (via RLS)
...
-- Visión por creador del expediente
...
-- Las tablas hijas heredan la visibilidad a través del expediente padre.
-- Para evitar recursión indirecta en RLS se usa `is_admin_or_owner(ticket_id)`
-- definida más abajo (SECURITY DEFINER).
...
-- ============================================================
-- 13. Triggers de actualización y mantenimiento de is_current
-- ============================================================
...
-- Al insertar una nueva corrida, marca como is_current=FALSE las anteriores
-- y mantiene el resultado actual en el ticket.
